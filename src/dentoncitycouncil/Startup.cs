...
namespace dentoncitycouncil {
    public class Startup {
        ...
        //private static string body_start = $"<div id=\"c\"><header id=\"h\"><section id=\"h_section1\"><aside class=\"f1\"></aside><div id=\"h-logo\">{Site.Svg.JoshDenton}</div><aside class=\"f1\"></aside></section><section id=\"h_section2\"><aside class=\"f1\"></aside><div id=\"h-logo2\">{Site.Svg.CityCouncil}</div><aside class=\"f1\"></aside></section><hr id=\"h_hr\" /></header><section id=\"n_section\"><aside class=\"f1\"></aside><nav id=\"n\" data-key=\"";
        //private static string body_mid = "\">" + Pages.Home.NavLink + Pages.Bio.NavLink + Pages.Campaign2013.NavLink + Pages.Sustainability.NavLink + Pages.HelpElect.NavLink + "</nav><aside class=\"f1\"></aside></section><main id=\"m\"><section id=\"content\">";
        ...
        private static string body_end = $"</section></main><footer id=\"f\"><h1 class=\"tac\">Vote for Josh on November 3!</h1><div id=\"f_disclaimer\">Paid for by Josh Denton for City Council</div><span>Candidate's Note: All views are Josh's and not those of his current or former employers.</span><hr /></footer></div>";
